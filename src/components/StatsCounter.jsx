...
const stats = [
  { id: 1, label: "Average increase in sales", value: 130 },
  { id: 2, label: "Average increase in sales", value: 40 },
  { id: 3, label: "Average increase in sales", value: 67 },
  { id: 4, label: "Average increase in sales", value: 98 },
];

const StatsCounter = () => {
  const [ref, inView] = useInView({
    triggerOnce: true, // count up only once
    threshold: 0.3,     // 30% in view to trigger
  });
